...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibGV3aXN5IiwiYSI6ImNrbG1qaXR2YzA5dmcyd3FyNXkyZ2lsbHcifQ.WsufR3Kmii4U_moKzM0ZJA';
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            res = _context.sent;
            if (res.data.status) (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " updated successfully"));
            _context.next = 11;
            break;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51IQALjIkK4PFwWmaOJLe1ALJMGiJVhkW1VLUIeNQNvvfGMP9Uc6x3TDAKMNxiX6SDrnE2XJ5LYrkECGQxZmyEYQj00Uc6AFjm9'); // 1) get checkout session from api
...
var passForm = document.querySelector('.form-user-password');
...
if (passForm) {
  passForm.addEventListener('submit', /*#__PURE__*/function () {
